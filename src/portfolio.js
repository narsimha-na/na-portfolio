...
import fitmint from "./assets/img/icons/common/fitmint_app_logo.png";
...
export const greetings = {
  ...
  desc2:
    "A passionate Full Stack Developer (Flutter & React JS), I enjoy building a great applications & solve problems for which I can be techincal bridge to you and your idea. So I would love to work on differnt kind of projects and solve problems",
  description:
    "A seasoned developer with over 4 years of experience, I excel in building user-friendly and scalable web and mobile applications using Flutter, ReactJS, and other technologies.  I've thrived in both startup and established company environments, spearheading projects like a user-friendly crypto marketplace and healthcare access apps. My ability to deliver successful MVPs and drive user engagement makes me a valuable asset for any team.",
  resumeLink:
    "https://drive.google.com/file/d/1hJCMr-shEcP_JBAuKW_zTh5BurkMl4s8/view",
};
...
export const educationInfo = [
  ...
  },
  {
    ...
    desc: "Completed my graduation from Institute of Aeronautical Engineering (B.Tech) in Computer Science & Engineering",
  },
];
...
export const projects = [
  {
    name: "Rush",
    desc: "Introducing Rush, the revolutionary trivia game that matches you with opponents, tests your knowledge on various topics, and rewards you with crypto for winning.",
    link: "https://play.google.com/store/apps/details?id=com.fitmint.rush",
  },
  {
    name: "Dumble",
    desc: "It’s easy to start the gym but it’s very very difficult to be consistent. Most often people will buy 3/6/12 month of gym membership and will quit going within few weeks. Dumble is an app designed to help you become consistent with your gym or home workouts.",
    link: "https://play.google.com/store/apps/details?id=com.fitmint.dumble",
  },
  {
    name: "Tata MD",
    ...
    link: "https://play.google.com/store/apps/details?id=com.tatamd.urbancare",
  },
  {
    name: "Fitmint",
    desc: "Get Paid to Walk & Run: Turn your steps into real rewards! It lets you get money by simply walking and running, making every step count towards a healthier lifestyle and a wealthier you.Crypto Rewards: Experience the power of cryptocurrency with Fitmint. Redeem your owned FITT tokens in popular cryptocurrencies",
    link: "https://play.google.com/store/apps/details?id=com.fitmint.app",
  },
  {
    name: "MAVEX",
